...
class TestModels:
    ...
    def test_scan_result(self):
        ...
        result.vulnerabilities.append(Vulnerability(title="Test", severity=Severity.HIGH))
        result.vulnerabilities.append(Vulnerability(title="Test2", severity=Severity.LOW))
    ...
    def test_scan_session(self, sample_firmware_info):
        ...
        result.vulnerabilities.append(Vulnerability(title="Critical", severity=Severity.CRITICAL))
        result.vulnerabilities.append(Vulnerability(title="High", severity=Severity.HIGH))
