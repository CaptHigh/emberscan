...
SNMP_COMMUNITIES = [
    'public', 'private', 'admin', 'manager', 'default',
    'cisco', 'secret', 'monitor', 'security', 'snmp',
]
...
class NetworkScanner(BaseScanner):
    ...
    def _scan_ports(self, target: str, ports: List[int] = None) -> List[int]:
        ...
        if not ports:
            ...
            ports = [
                21, 22, 23, 25, 53, 69, 80, 81, 443,
                161, 162, 443, 554, 1080, 1883,
                5000, 5060, 8000, 8080, 8081, 8443,
                8888, 9000, 9090, 49152
            ]
    ...
    def _check_ssh(self, target: str) -> List[Vulnerability]:
        ...
        try:
            ...
            result = subprocess.run(
                ['ssh', '-vv', '-o', 'BatchMode=yes', '-o', 'ConnectTimeout=5',
                 f'{target}', 'exit'],
